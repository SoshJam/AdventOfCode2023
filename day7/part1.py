...
def get_hand_type(hand: str):
    ...
    if card_counts[0] == 3 and card_counts[1] == 1:
        return HandType.THREE_OF_A_KIND
    if card_counts[0] == 2 and card_counts[1] == 2:
        return HandType.TWO_PAIR
    if card_counts[0] == 2 and card_counts[1] == 1:
...
def hand_to_int(hand: str):
    ...
    # Cards
    sum += (cards.index(hand[0]) + 2) * 100000000
    sum += (cards.index(hand[1]) + 2) * 1000000
    sum += (cards.index(hand[2]) + 2) * 10000
    sum += (cards.index(hand[3]) + 2) * 100
    sum += (cards.index(hand[4]) + 2) * 1
